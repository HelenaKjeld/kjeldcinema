            ...
            <div class="flex justify-between items-center">
                ...
                <nav>
                    <ul class="flex space-x-6">
                        <li><a href="#" class="hover:text-red-400 transition">Movies</a></li>
                        <li><a href="#" class="hover:text-red-400 transition">Cinemas</a></li>
                        <li><a href="#" class="hover:text-red-400 transition">Offers</a></li>
                        <li><a href="#" class="hover:text-red-400 transition">My Bookings</a></li>
                    </ul>
                </nav>
            </div>
        </div>
